...
const FoodServes = () => {
    return (
        <div className="w-4/5 mx-auto bg-gray-900 rounded-lg my-10">
            <div className="flex flex-col text-center lg:flex-row justify-around items-center gap-12 px-5 md:px-16 py-20 ">
                <div className='space-y-3'>
                    ...
                    <p className='text-sm'>A team of dreamers and doers building unique interactive music and art</p>
                </div>
                <div className='space-y-3'>
